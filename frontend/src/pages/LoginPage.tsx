      ...
      <div className="w-full lg:w-[60%] flex items-center justify-center p-8 bg-[#080808]">
        ...
        >
          <div className="bg-[#0e0e0e] border border-white/[0.08] rounded-2xl p-8 w-full max-w-sm shadow-2xl">
            <h2 className="text-[#fafafa] text-xl font-semibold tracking-tight mb-6">Sign in to your account</h2>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="bg-amber-500 hover:bg-amber-400 active:bg-amber-600 text-black font-semibold py-2.5 rounded-lg w-full transition-all duration-150 text-sm mt-2 flex items-center justify-center gap-2"
              >
                {isLoading ? (
